...
theme.Header = (function() {
  ...
  function init() {
    ...
    // Mouseenter
    cache.$parents.on('mouseenter', function(evt) {
      var el = $(this);
    ...
    cache.$parents.on('mouseleave', function() {
      hideDropdown($(this));
    });
...
theme.MobileNav = (function() {
  ...
  function openMobileNav() {
    ...
    $('.toggle-menu-bg').addClass('js-drawer-menu');

    var translateHeaderHeight = cache.$siteHeader.outerHeight() + cache.$siteHeader.offset().top + 20;
  ...
  function closeMobileNav() {
    ...
    $('.toggle-menu-bg').removeClass('js-drawer-menu');
...
theme.Search = (function() {
  ...
  function init() {
    ...
    $(selectors.siteHeaderSearchToggle).on('click', function() {
      var searchHeight = 75;
      var searchOffset = $(selectors.searchHeader).outerHeight() - 30;
